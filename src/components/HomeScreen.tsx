...
export function HomeScreen({ navigateTo, gameState }: HomeScreenProps) {
  ...
  return (
    ...
    >
      ...
      {/* Main content */}
      <section className="relative z-10 flex flex-col items-center justify-center h-full gap-8 px-16">
        {/* Logo and title */}
        <motion.div
        ...
        >
          <div className="bg-white rounded-3xl shadow-2xl px-16 py-8 border-8 border-yellow-400 inline-block">
            <h1 className="text-6xl text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-600 to-orange-600">
              <span role="img" aria-label="Emoji de rompecabezas">
                🧩
              </span>{" "}
              Arma la Frase
            </h1>
        ...
        >
          ...
          >
            <Play className="w-16 h-16 mr-6 fill-white" aria-hidden="true" />
            ¡Jugar!
          </Button>
        </motion.div>
        ...
        >
          ...
          >
            <Gift className="w-10 h-10 mr-4" aria-hidden="true" />
            Mis Premios
          </Button>
          ...
          >
            <HelpCircle className="w-10 h-10 mr-4" aria-hidden="true" />
            Cómo jugar
          </Button>
          ...
          <Button
            ...
            title="Ajustes (Alt+A)"
          >
            <Settings className="w-10 h-10 mr-4" aria-hidden="true" />
            Ajustes
          </Button>
        </motion.nav>
      </section>
